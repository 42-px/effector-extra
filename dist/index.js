...
function batchEvents(trigger, timeout) {
  ...
  var pushStore = createEvent({
    name: "pushStore",
    sid: "-99i15u"
  });
  var resetStore = createEvent({
    name: "resetStore",
    sid: "-ka34j3"
  });
  var timeoutEnd = createEvent({
    name: "timeoutEnd",
    sid: "-8qf3eg"
  });
  var $storedEvents = createStore([], {
    name: "$storedEvents",
    sid: "tj0mgu"
  });
...
export { attachWrapper, batchEvents, createService, mockEffects, mockStores };
